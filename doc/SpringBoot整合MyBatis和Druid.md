...
3.使用Druid数据源:
    (关系型数据库连接池,https://github.com/alibaba/druid;提供连接池的功能和提供监控功能)
...
4.使用MyBatis:
    ...
    [7]启动项目访问: http://localhost:8080/web/querystudent/001
```